    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "0 0 60px rgba(13,148,136,0.15), 0 25px 50px rgba(0,0,0,0.5)",
        }}
      >
        {/* Header strip */}
        <div
        ...
        >
          ...
          <div>
            ...
            <p className="text-teal-200 text-[11px] mt-0.5">Digital Gate Pass</p>
          </div>
        ...
        <div className="px-6 pb-4 space-y-3">
          <div className="rounded-2xl p-4 space-y-2.5" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(13,148,136,0.15)" }}>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-teal-300/70 text-xs mt-0.5">{visitor.visitorPhone}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>
                <p className="text-teal-400/60 uppercase tracking-wide text-[10px]">Visiting</p>
                <p className="text-white font-semibold mt-0.5">Flat {visitor.flatNumber}</p>
                <p className="text-teal-300/70">{visitor.residentName}</p>
              </div>
              <div>
                <p className="text-teal-400/60 uppercase tracking-wide text-[10px]">Expected</p>
        ...
        <div className="flex flex-col items-center pb-5 px-6 gap-3">
          <div
            ...
            style={{ background: "#ffffff", border: "3px solid rgba(13,148,136,0.4)", boxShadow: "0 0 30px rgba(13,148,136,0.2)" }}
          >
            {qrDataUrl
              ? <img src={qrDataUrl} alt="Gate pass QR code" width={220} height={220} style={{ display: "block", borderRadius: "8px" }} />
              : <div style={{ width: 220, height: 220, display: "flex", alignItems: "center", justifyContent: "center" }}><div className="w-8 h-8 rounded-full border-2 border-teal-400 border-t-transparent animate-spin" /></div>
            }
          </div>

          {/* Pass code */}
          <div className="text-center">
            <p className="text-teal-400/60 text-[10px] uppercase tracking-widest">Pass Code</p>
            <p className="font-mono font-bold text-2xl text-white tracking-[0.3em] mt-0.5">{visitor.passCode}</p>
          </div>

          <p className="text-teal-400/40 text-[10px] text-center">
        ...
        <div
          ...
          style={{ background: "rgba(0,0,0,0.3)", borderTop: "1px solid rgba(13,148,136,0.1)" }}
        >
          <p className="text-[10px] text-teal-400/50">Valid for single entry</p>
          <p className="text-[10px] text-teal-400/50">blocksense.ai</p>
        </div>
      </div>
    </div>
  );
